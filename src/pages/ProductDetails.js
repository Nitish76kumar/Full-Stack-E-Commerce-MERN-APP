        ...
        {loading ? (
          ...
          <div className="flex flex-col gap-1">
            ...
            <div className="flex items-center gap-3 my-2">
              <button
                className="border-2 border-yellow-500 rounded px-3 py-1 min-w-[120px] text-yellow-500 font-medium hover:bg-yellow-500 hover:text-white"
                onClick={(e) => handleBuyProduct(e, data?._id)}
              >
                Buy
              </button>
              <button
                className="border-2 border-yellow-500 rounded px-3 py-1 min-w-[120px] font-medium text-white bg-yellow-500 hover:text-yellow-500 hover:bg-white"
